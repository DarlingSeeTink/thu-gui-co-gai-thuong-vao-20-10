...
<script>
    ...
    const textToType = "Võ Thị Xuân Nghi";
    ...
    const textLetterP = "Gửi em. 20/10 này, a chúc người a thương, a yêu có một ngày lễ thật vui vẻ hạnh phúc, tràn đầy sức khoẻ, ngày càng xinh đẹp hơn và luôn nở nụ cười trên môi, mong em có tất cả trừ vất vả nhaaa. dù có thế nào đi nữa a vẫn luôn bên e Nghi à:3.";
